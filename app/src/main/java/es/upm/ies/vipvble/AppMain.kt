...
import es.upm.ies.vipvble.service.ForegroundBeaconScanService
import es.upm.ies.vipvble.ui.ActMain
import es.upm.ies.vipvble.workers.SessionFilesUploadWorker
...
class AppMain : Application(), ComponentCallbacks2 {
    ...
    companion object {
        ...
        const val ACTION_STOP_SESSION = "es.upm.ies.vipvble.STOP_SESSION"
